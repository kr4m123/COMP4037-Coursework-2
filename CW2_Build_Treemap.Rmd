...
```{r}
# create a new column to group diet types into meat eaters and non-meat eaters
treemap_data <- treemap_data %>%
  mutate(
...
ggplot(treemap_data,
       aes(area = total_impact_compressed,  
           fill = total_impact,  
           label = paste0(sex, "\n(", age_group, ")\n", round(total_impact, 2)),  # the actual label displayed on each rectangle
  ...
  # borders around meat eaters vs non meat eaters
